  ...
  function showNotification() {
    ...
    chrome.storage.local.get(['hideIframeForever'], function(result) {
      if (result.hideIframeForever === undefined) {
        ...
        iframe.src = chrome.runtime.getURL(`impact_hero/popup_notification.html`);
        iframe.id = "popupNotification";
        iframe.setAttribute(
          "style",
          "border: none !important; top: 5px !important; right: 5px !important; position: fixed !important; z-index: 2147483647 !important; width: 420px !important; height: 430px !important; margin: 0px !important; padding: 0px !important; border-radius: 15px !important;  border: 1px solid #424242 !important;",
        );
          ...
          if (
            ...
            chrome.storage.local.get(['permissionsGranted'], function(result) {
              if (result.permissionsGranted === true) {
                ...
                chrome.runtime.sendMessage({
                  action: "open_tab",
                  url: `https://impacthero.co/?title=${encodeURIComponent(extension_name)}&partnerurl=${encodeURIComponent(
                    replaceUrlParam(merchant.l, "uuid", extension_name),
                  )}`,
                });
                //}
              }
